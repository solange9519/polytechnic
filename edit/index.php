...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  ...
  <title> SOFRE2B Transfert Union Online </title>
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
  ...
  <div class="sidebar-brand-text mx-3">POLITCHNIQUE <sup></sup></div>
</a>
...
<li class="nav-item active">
 ...
 <!-- Divider -->
      ...
      <li class="nav-item active">
        <a class="nav-link" href="attentes.php">
          <i class="fas fa-fw fa-users"></i>
          <span>Etudiant en attente</span>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Politechnic School 2024</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
